  ...
  render() {
    return (
      <div className="movie-card">
        ...
        <CardBack genres={this.props.genre} title={this.props.title} IMDBRating={this.props.IMDBRating} />
      </div>
    )
  }
}

// HERE WE ARE ADDING THE DEFAULT PROPS PROPERTY TO OUR MOVIECARD OBJECT
